...
- It attributes ART producer wait on full train-ring admission into scheduler train denominators, so bridge-side backpressure reduces marginal improvement per dollar-second instead of only incrementing a queue counter.
