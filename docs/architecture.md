...
- Static-vs-objective ablation harnesses that assert positive north-star lift from scheduler control, adaptive action-space control, and the combined closed-loop controller.
