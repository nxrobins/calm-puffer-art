...
- `north_star/accounted_published_policy_reward_improving_experience_per_dollar_second`: the same published-policy numerator divided by accounted rollout, trainer, trainer-wait, train-ring admission wait, promotion-evaluation, admission-delay, and queue-wait spend.
