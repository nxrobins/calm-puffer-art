...
- `costs/accounted_dollar_seconds`: rollout, trainer, trainer-wait, train-ring admission wait, stale-only train-ring admission overhead, promotion-evaluation, admission-delay, and queue-wait attribution combined.
