...
- `costs/trainer_wait_dollar_seconds`: trainer-side time spent waiting for a ready train batch. The ART bridge separately reports `art_backend/train_ring_admission_wait_dollar_seconds` for producer time spent waiting to enter the train ring under backpressure and includes that wait in scheduler train cost for the admitted batch.
